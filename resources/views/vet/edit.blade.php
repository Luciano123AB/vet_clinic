            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body no-padding">
                        <form action="/vet/{{ $theVet->id }}" method="post" role="form">
                            @csrf

                            <div class="box-body">
                                <div class="form-group">
                                    <label for="name">Nome</label>
                                    <input type="text" class="form-control" id="name" name="name" oninvalid="this.setCustomValidity('Campo requerido.')" onchange="try{setCustomValidity('')}catch(e){}" value="{{ $theVet->name }}" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="state" name="state">
                                        ...
                                        <option value="TO" @if ($theVet->state == 'TO') {{ 'selected' }} @endif>TO</option>
                                    </select>
                                </div>
                            </div>
                            <br>
