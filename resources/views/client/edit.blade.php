            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body no-padding">
                        <form action="/client/{{ $theClient->id }}" method="post" role="form">
                            @csrf

                            <div class="box-body">
                                <div class="form-group">
                                    <label for="name">Nome</label>
                                    <input type="text" class="form-control" id="name" name="name" oninvalid="this.setCustomValidity('Campo requerido.')" onchange="try{setCustomValidity('')}catch(e){}" value="{{ $theClient->name }}" required>
                                </div>
                                <div class="form-group">
