...
@section('body')
    <script>
        ...
        function remove_procedure_consultation(element) {
            ...
            document.getElementById('qte_procedure_consultation').innerHTML = parseInt(document.getElementById('qte_procedure_consultation').innerHTML) - 1;
            //Atualizar(diminuindo) o valor total na tabela procedimentos:
            document.getElementById('consultation_value').innerHTML = (parseFloat(document.getElementById('consultation_value').innerHTML) - parseFloat(document.getElementById('grid').rows[element.parentNode.parentNode.rowIndex].cells[2].innerHTML)).toFixed(2);
            //Total value:
            document.getElementById('total_value').value = document.getElementById('consultation_value').innerHTML;
            //Deletar row:
